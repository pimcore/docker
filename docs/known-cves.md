...
_Generated 2026-07-31 03:58 UTC._
...
**No fixable CVE was available upstream for any image in this run.** Debian ships no fix for any of the 3455 distinct CVEs found, so Copa had nothing to patch.
...
**2395 `linux-libc-dev` rows (2395 distinct CVEs) are excluded from the tables.** These are Linux kernel *header* CVEs. A container runs on the host kernel, so they are not reachable inside these images. They remain in `cve-data.json`, uploaded as the `cve-report-json` artifact on the release run.
...
|-------|------|------|------|-----|-----|-----|---------|-----------|--------------|
| `php8.2-debug-v2.3` | amd64 | 34 | 408 | 1754 | 592 | 43 | 0 | not-produced | `56fabb3133fb` |
| `php8.2-debug-v2.3` | arm64 | 34 | 404 | 1748 | 589 | 37 | 0 | not-produced | `2336f82a82ab` |
| `php8.2-debug-v3.8` | amd64 | 33 | 255 | 1162 | 561 | 45 | 0 | not-produced | `b60fd057ed8a` |
| `php8.2-debug-v3.8` | arm64 | 33 | 255 | 1162 | 561 | 45 | 0 | not-produced | `63d481f33e59` |
| `php8.2-max-v2.3` | amd64 | 121 | 1540 | 2816 | 1084 | 564 | 0 | not-produced | `8f5ceb75036d` |
| `php8.2-max-v2.3` | arm64 | 121 | 1536 | 2810 | 1080 | 558 | 0 | not-produced | `9219e2e0d2ad` |
| `php8.2-max-v3.8` | amd64 | 38 | 375 | 1446 | 814 | 411 | 0 | not-produced | `5dadfd154051` |
| `php8.2-max-v3.8` | arm64 | 38 | 374 | 1444 | 810 | 407 | 0 | not-produced | `911febdd1064` |
| `php8.2-min-v2.3` | amd64 | 11 | 333 | 1557 | 331 | 12 | 0 | not-produced | `e35b696f2d6b` |
| `php8.2-min-v2.3` | arm64 | 11 | 333 | 1557 | 331 | 12 | 0 | not-produced | `d003cc8ad028` |
| `php8.2-min-v3.8` | amd64 | 9 | 180 | 960 | 294 | 19 | 0 | not-produced | `ea7fde4c9069` |
| `php8.2-min-v3.8` | arm64 | 9 | 180 | 960 | 294 | 19 | 0 | not-produced | `bbb8738bd00c` |
| `php8.2-supervisord-v2.3` | amd64 | 40 | 442 | 1833 | 625 | 48 | 0 | not-produced | `3141a4b765ae` |
| `php8.2-supervisord-v2.3` | arm64 | 40 | 438 | 1827 | 622 | 42 | 0 | not-produced | `1b68ed60e779` |
| `php8.2-supervisord-v3.8` | amd64 | 36 | 286 | 1224 | 580 | 49 | 0 | not-produced | `fe7fa9476a3d` |
| `php8.2-supervisord-v3.8` | arm64 | 36 | 286 | 1224 | 580 | 49 | 0 | not-produced | `56e9e004659a` |
| `php8.2-v2.3` | amd64 | 34 | 408 | 1754 | 592 | 43 | 0 | not-produced | `b7378d90cae0` |
| `php8.2-v2.3` | arm64 | 34 | 404 | 1748 | 589 | 37 | 0 | not-produced | `aaeb4411f6e5` |
| `php8.2-v3.8` | amd64 | 33 | 255 | 1162 | 561 | 45 | 0 | not-produced | `c9ce0f8faae0` |
| `php8.2-v3.8` | arm64 | 33 | 255 | 1162 | 561 | 45 | 0 | not-produced | `780831ed3b44` |
| `php8.3-debug-v3.8` | amd64 | 33 | 255 | 1162 | 561 | 45 | 0 | not-produced | `68f086159801` |
| `php8.3-debug-v3.8` | arm64 | 33 | 255 | 1162 | 561 | 45 | 0 | not-produced | `7612ac78de10` |
| `php8.3-max-v3.8` | amd64 | 38 | 375 | 1446 | 814 | 411 | 0 | not-produced | `6144b7dd0d1b` |
| `php8.3-max-v3.8` | arm64 | 38 | 374 | 1444 | 810 | 407 | 0 | not-produced | `f7a6a5d482f9` |
| `php8.3-min-v3.8` | amd64 | 9 | 180 | 960 | 294 | 19 | 0 | not-produced | `9bd048ddc0a4` |
| `php8.3-min-v3.8` | arm64 | 9 | 180 | 960 | 294 | 19 | 0 | not-produced | `acf72c596999` |
| `php8.3-supervisord-v3.8` | amd64 | 36 | 286 | 1224 | 580 | 49 | 0 | not-produced | `80ac0b8e189f` |
| `php8.3-supervisord-v3.8` | arm64 | 36 | 286 | 1224 | 580 | 49 | 0 | not-produced | `f3a3ea182ef1` |
| `php8.3-v3.8` | amd64 | 33 | 255 | 1162 | 561 | 45 | 0 | not-produced | `96896fe0adac` |
| `php8.3-v3.8` | arm64 | 33 | 255 | 1162 | 561 | 45 | 0 | not-produced | `bd04ea4e0a35` |
| `php8.4-debug-v4.2` | amd64 | 33 | 255 | 1186 | 620 | 45 | 0 | not-produced | `168a7b0ef162` |
| `php8.4-debug-v4.2` | arm64 | 33 | 255 | 1186 | 620 | 45 | 0 | not-produced | `26c8c0a6f302` |
| `php8.4-max-v4.2` | amd64 | 38 | 375 | 1454 | 833 | 411 | 0 | not-produced | `6d9601cf0467` |
| `php8.4-max-v4.2` | arm64 | 38 | 374 | 1452 | 829 | 407 | 0 | not-produced | `913dcc550afa` |
| `php8.4-min-v4.2` | amd64 | 9 | 180 | 960 | 294 | 19 | 0 | not-produced | `9c8fc2407121` |
| `php8.4-min-v4.2` | arm64 | 9 | 180 | 960 | 294 | 19 | 0 | not-produced | `dbdfda1a1944` |
| `php8.4-supervisord-v4.2` | amd64 | 36 | 286 | 1248 | 639 | 49 | 0 | not-produced | `79a944e7c20f` |
| `php8.4-supervisord-v4.2` | arm64 | 36 | 286 | 1248 | 639 | 49 | 0 | not-produced | `ccfb32d5944a` |
| `php8.4-v4.2` | amd64 | 33 | 255 | 1186 | 620 | 45 | 0 | not-produced | `65e6c64f678d` |
| `php8.4-v4.2` | arm64 | 33 | 255 | 1186 | 620 | 45 | 0 | not-produced | `dcaf33e9d5d4` |
| `php8.5-debug-v5.2` | arm64 | 34 | 255 | 701 | 1051 | 131 | 0 | not-produced | `8537410b5fd0` |
| `php8.5-max-v5.2` | arm64 | 42 | 352 | 859 | 1200 | 487 | 0 | not-produced | `83cb6c77817c` |
| `php8.5-min-v5.2` | arm64 | 18 | 94 | 418 | 669 | 36 | 0 | not-produced | `23e05692ca66` |
| `php8.5-supervisord-v5.2` | arm64 | 35 | 272 | 736 | 1069 | 135 | 0 | not-produced | `1f5a795d8987` |
| `php8.5-v5.2` | arm64 | 34 | 255 | 701 | 1051 | 131 | 0 | not-produced | `c82287e23fc2` |

_`CRIT`-`UNK` and `Fixable` above are **raw Trivy totals for the image as published**: unlike the tabulated counts earlier in this report they still include the 2395 un-tabulated `linux-libc-dev` rows, so they intentionally exceed every tabulated count above. A `CRIT`/`HIGH` here with no matching row in any detail table is a kernel-header CVE -- see **Not tabulated** above. `Fixable` is also measured across both OS and library packages, wider than the OS-packages-only scope of the scan that feeds Copa -- severity plays no part in that difference._
...
| [CVE-2026-17653](https://nvd.nist.gov/vuln/detail/CVE-2026-17653) | CRITICAL | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
...
| [CVE-2026-16804](https://nvd.nist.gov/vuln/detail/CVE-2026-16804) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-16805](https://nvd.nist.gov/vuln/detail/CVE-2026-16805) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-16806](https://nvd.nist.gov/vuln/detail/CVE-2026-16806) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-16807](https://nvd.nist.gov/vuln/detail/CVE-2026-16807) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17659](https://nvd.nist.gov/vuln/detail/CVE-2026-17659) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17663](https://nvd.nist.gov/vuln/detail/CVE-2026-17663) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17671](https://nvd.nist.gov/vuln/detail/CVE-2026-17671) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17672](https://nvd.nist.gov/vuln/detail/CVE-2026-17672) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17673](https://nvd.nist.gov/vuln/detail/CVE-2026-17673) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17677](https://nvd.nist.gov/vuln/detail/CVE-2026-17677) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17679](https://nvd.nist.gov/vuln/detail/CVE-2026-17679) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17682](https://nvd.nist.gov/vuln/detail/CVE-2026-17682) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17689](https://nvd.nist.gov/vuln/detail/CVE-2026-17689) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17690](https://nvd.nist.gov/vuln/detail/CVE-2026-17690) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17697](https://nvd.nist.gov/vuln/detail/CVE-2026-17697) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17699](https://nvd.nist.gov/vuln/detail/CVE-2026-17699) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17710](https://nvd.nist.gov/vuln/detail/CVE-2026-17710) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17712](https://nvd.nist.gov/vuln/detail/CVE-2026-17712) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17714](https://nvd.nist.gov/vuln/detail/CVE-2026-17714) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17716](https://nvd.nist.gov/vuln/detail/CVE-2026-17716) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17778](https://nvd.nist.gov/vuln/detail/CVE-2026-17778) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-17823](https://nvd.nist.gov/vuln/detail/CVE-2026-17823) | HIGH | `chromium-sandbox` | unpatched · no fix | 5 images · v2.3, v3.8, v4.2, v5.2 |
...
| [CVE-2026-8932](https://nvd.nist.gov/vuln/detail/CVE-2026-8932) | HIGH | `curl` | unpatched · no fix | 25 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-9079](https://nvd.nist.gov/vuln/detail/CVE-2026-9079) | HIGH | `curl` | unpatched · no fix | 5 images · v5.2 |
| [CVE-2026-9080](https://nvd.nist.gov/vuln/detail/CVE-2026-9080) | HIGH | `curl` | unpatched · no fix | 5 images · v5.2 |
| [CVE-2026-9545](https://nvd.nist.gov/vuln/detail/CVE-2026-9545) | HIGH | `curl` | unpatched · no fix | 5 images · v5.2 |
...
| [CVE-2026-56208](https://nvd.nist.gov/vuln/detail/CVE-2026-56208) | HIGH | `libaom3` | unpatched · no fix | 5 images · v5.2 |
| [CVE-2026-56209](https://nvd.nist.gov/vuln/detail/CVE-2026-56209) | HIGH | `libaom3` | unpatched · no fix | 5 images · v5.2 |
| [CVE-2026-56210](https://nvd.nist.gov/vuln/detail/CVE-2026-56210) | HIGH | `libaom3` | unpatched · no fix | 5 images · v5.2 |
| [CVE-2026-56211](https://nvd.nist.gov/vuln/detail/CVE-2026-56211) | HIGH | `libaom3` | unpatched · no fix | 5 images · v5.2 |
...
| [CVE-2026-8932](https://nvd.nist.gov/vuln/detail/CVE-2026-8932) | HIGH | `libcurl3-gnutls` | unpatched · no fix | 16 images · v2.3, v3.8, v4.2 |
...
| [CVE-2026-8932](https://nvd.nist.gov/vuln/detail/CVE-2026-8932) | HIGH | `libcurl3t64-gnutls` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2026-9079](https://nvd.nist.gov/vuln/detail/CVE-2026-9079) | HIGH | `libcurl3t64-gnutls` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2026-9080](https://nvd.nist.gov/vuln/detail/CVE-2026-9080) | HIGH | `libcurl3t64-gnutls` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2026-9545](https://nvd.nist.gov/vuln/detail/CVE-2026-9545) | HIGH | `libcurl3t64-gnutls` | unpatched · no fix | 4 images · v5.2 |
...
| [CVE-2026-8932](https://nvd.nist.gov/vuln/detail/CVE-2026-8932) | HIGH | `libcurl4` | unpatched · no fix | 20 images · v2.3, v3.8, v4.2 |
...
| [CVE-2026-8932](https://nvd.nist.gov/vuln/detail/CVE-2026-8932) | HIGH | `libcurl4t64` | unpatched · no fix | 5 images · v5.2 |
| [CVE-2026-9079](https://nvd.nist.gov/vuln/detail/CVE-2026-9079) | HIGH | `libcurl4t64` | unpatched · no fix | 5 images · v5.2 |
| [CVE-2026-9080](https://nvd.nist.gov/vuln/detail/CVE-2026-9080) | HIGH | `libcurl4t64` | unpatched · no fix | 5 images · v5.2 |
| [CVE-2026-9545](https://nvd.nist.gov/vuln/detail/CVE-2026-9545) | HIGH | `libcurl4t64` | unpatched · no fix | 5 images · v5.2 |
...
| [CVE-2026-56131](https://nvd.nist.gov/vuln/detail/CVE-2026-56131) | HIGH | `libexpat1` | unpatched · no fix | 16 images · v2.3, v3.8, v4.2 |
...
| [CVE-2026-41071](https://nvd.nist.gov/vuln/detail/CVE-2026-41071) | HIGH | `libheif-plugin-aomenc` | unpatched · no fix | 4 images · v5.2 |
...
| [CVE-2026-41071](https://nvd.nist.gov/vuln/detail/CVE-2026-41071) | HIGH | `libheif-plugin-dav1d` | unpatched · no fix | 4 images · v5.2 |
...
| [CVE-2026-41071](https://nvd.nist.gov/vuln/detail/CVE-2026-41071) | HIGH | `libheif-plugin-libde265` | unpatched · no fix | 4 images · v5.2 |
...
| [CVE-2026-41071](https://nvd.nist.gov/vuln/detail/CVE-2026-41071) | HIGH | `libheif-plugin-x265` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2026-47178](https://nvd.nist.gov/vuln/detail/CVE-2026-47178) | HIGH | `libheif-plugin-x265` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2025-68431](https://nvd.nist.gov/vuln/detail/CVE-2025-68431) | HIGH | `libheif1` | unpatched · no fix | 20 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-32740](https://nvd.nist.gov/vuln/detail/CVE-2026-32740) | HIGH | `libheif1` | unpatched · no fix | 20 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-32741](https://nvd.nist.gov/vuln/detail/CVE-2026-32741) | HIGH | `libheif1` | unpatched · no fix | 20 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-32882](https://nvd.nist.gov/vuln/detail/CVE-2026-32882) | HIGH | `libheif1` | unpatched · no fix | 20 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-41071](https://nvd.nist.gov/vuln/detail/CVE-2026-41071) | HIGH | `libheif1` | unpatched · no fix | 20 images · v2.3, v3.8, v4.2, v5.2 |
| [CVE-2026-47178](https://nvd.nist.gov/vuln/detail/CVE-2026-47178) | HIGH | `libheif1` | unpatched · no fix | 20 images · v2.3, v3.8, v4.2, v5.2 |
...
| [CVE-2026-10118](https://nvd.nist.gov/vuln/detail/CVE-2026-10118) | HIGH | `libpoppler102` | unpatched · no fix | 4 images · v2.3 |
...
| [CVE-2026-0966](https://nvd.nist.gov/vuln/detail/CVE-2026-0966) | HIGH | `libssh-4` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2026-15370](https://nvd.nist.gov/vuln/detail/CVE-2026-15370) | HIGH | `libssh-4` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2026-3731](https://nvd.nist.gov/vuln/detail/CVE-2026-3731) | HIGH | `libssh-4` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2026-59847](https://nvd.nist.gov/vuln/detail/CVE-2026-59847) | HIGH | `libssh-4` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2026-59849](https://nvd.nist.gov/vuln/detail/CVE-2026-59849) | HIGH | `libssh-4` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2026-59850](https://nvd.nist.gov/vuln/detail/CVE-2026-59850) | HIGH | `libssh-4` | unpatched · no fix | 4 images · v5.2 |
| [CVE-2026-55199](https://nvd.nist.gov/vuln/detail/CVE-2026-55199) | HIGH | `libssh2-1` | unpatched · no fix | 20 images · v2.3, v3.8, v4.2 |
| [CVE-2026-55200](https://nvd.nist.gov/vuln/detail/CVE-2026-55200) | HIGH | `libssh2-1` | unpatched · no fix | 20 images · v2.3, v3.8, v4.2 |
...
| [CVE-2026-10118](https://nvd.nist.gov/vuln/detail/CVE-2026-10118) | HIGH | `poppler-utils` | unpatched · no fix | 4 images · v2.3 |
